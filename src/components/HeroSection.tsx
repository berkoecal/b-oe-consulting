    ...
    <section className="relative min-h-screen flex items-center pt-40 pb-12 overflow-hidden bg-transparent">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="h-[1px] w-8 md:w-12 bg-primary-500" />
            <span className="text-primary-400 font-semibold tracking-widest uppercase text-xs md:text-sm">
              {dict.hero.subtitle}
            </span>
          </motion.div>
          ...
          >
            ...
            <span className="italic text-gray-400">{dict.hero.title2}</span>{" "}
